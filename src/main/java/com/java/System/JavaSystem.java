...
public class JavaSystem {
    ...
    /**
     * System.getProperty 获取系统属性 个系统属性集合总是包含以下键的值： 键 相关值的描述 java.version Java
     * 运行时环境版本 java.vendor Java 运行时环境供应商 java.vendor.url Java 供应商的 URL java.home
     * Java 安装目录 java.vm.specification.version Java 虚拟机规范版本
     ...
     * @param key
     */
    public static void getSystemProperty(String key) {
